/* Get AES GCM nonces from server
 * code: Hanno Böck, license: CC0 / public domain
 *
 * To compile:
 * - First patch a current version of OpenSSL (1.0.2e) with openssl-patch-show-server-iv.diff
 * - Compile OpenSSL (./config; make) and get libssl.a and libcrypto.a
 * - Compile this tool with:
 *   - gcc -Ofast -o getnonce getnonce libssl.a libcrypto.a -ldl
 */
